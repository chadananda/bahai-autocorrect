...
const commonMisspellings = [
  ...
  "Abul'?[- ]? = Abu'l-", // ADDED
  "Ab[uú]'?([lsh]+)[-] ? = Abu’$1-",
  "Ab[uú]'?l[- ]*[GQ][áa]s[ie]m = Abu’l-Qásim", // This was changed from Abú'l-Qásim, which seems to be a misspelling
  "Abb[uú]d = Abbúd",
  "Abha = Abhá",
  ...
  "Dein = Dín",
  "Dhikr = <u>Dh</u>ikr",
  "Dhikr'?u'?ll[aá]h = <u>Dh</u>ikru’lláh",
  ...
  "Ism[ou]'?ll[aá]h = Ismu’lláh",
  "Ism[ou]'?ll[aá]h[ou]?'?l = Ismu’lláhu’l",
  ...
  "Port\s+Said = Port Sa‘íd",
  "Q[aá][y]?[-‘’']?[ie]m = Qá’im",
  "Q[aá]'?in = Qá'in",
  "Q[aá]'?in[ií] = Qá'iní",
  "Q[aá]d[ií][-]?[Kk][aá]l[aá] = Qádí-Kalá",
  "Q[aá]d[ií][-]?[Kk][aá]l[aá]'?i = Qádí-Kalá’í",
  ...
  "Shaykh'?[Eua]'?([ldrstz]) = <u>Sh</u>ay<u>kh</u>u’$1",
  "Shaykh() = <u>Sh</u>ay<u>kh</u>",
  "sheikh?() = <u>sh</u>ay<u>kh</u>",
  "Sheikh?() = <u>Sh</u>ay<u>kh</u>",
  "<u>Sh</u>ay<u>kh</u>u’l-Isl[aá]m = <u>Sh</u>ay<u>kh</u>u’l-Islám",
  "Shogh?ie? = Shoghi",
  "Sul[ṭt][aá]n() = Sulṭán",
  "Suleiman = Sulaymán",
